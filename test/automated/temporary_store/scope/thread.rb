...
context "Temporary Store" do
  context "Thread Scope" do
    ...
    store = EntityCache::Store::Temporary::Scope::Thread.build(subject)
    ...
    context "Get Record From Other Store" do
      context "Subjects Match" do
        other_store = EntityCache::Store::Temporary::Scope::Thread.build(subject)
      ...
      context "Subjects Do Not Match" do
        ...
        other_store = EntityCache::Store::Temporary::Scope::Thread.build(other_subject)
      ...
      context "Within Another Thread" do
        ...
        thread = Thread.new do
          other_store = EntityCache::Store::Temporary::Scope::Global.build(subject)
